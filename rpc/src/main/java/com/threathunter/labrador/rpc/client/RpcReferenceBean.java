...
import com.threathunter.labrador.common.util.ClassLoaderUtils;
import com.threathunter.labrador.rpc.constant.RegistryType;
import com.threathunter.labrador.rpc.constant.RpcConstant;
import com.threathunter.labrador.rpc.constant.SerializeType;
import com.threathunter.labrador.rpc.registry.IServiceDiscovery;
...
public class RpcReferenceBean implements BeanPostProcessor {
    ...
    public RpcReferenceBean() {
        IServiceDiscovery serviceDiscovery = ClassLoaderUtils.getInstance(RegistryType.SIMPLE.getDiscoveryClass());
        IRpcSerialize rpcSerialize = ClassLoaderUtils.getInstance(SerializeType.HESSIAN.getSerializeClass());
