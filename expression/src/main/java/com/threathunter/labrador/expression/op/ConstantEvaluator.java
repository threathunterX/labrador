...
import com.threathunter.labrador.expression.Evaluable;
	...
	private Method getOperator(Operator op, Object obj){
		...
		if(!evalMethod.containsKey(ck)){
			...
			for(Method om : obj.getClass().getMethods()){
				com.threathunter.labrador.expression.annotation.Operator anno = om.getAnnotation(com.threathunter.labrador.expression.annotation.Operator.class);
